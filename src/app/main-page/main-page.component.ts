...
export class MainPageComponent {
  ...
  intro = `An easy and quick dish, perfect for any meal. 
  ...
  preparationTime = new Map<string, string>([
  ...
  nutrition = `The table below shows nutritional values per serving without the additional 
  fillings.`;
  nutritionRows = new Map<string, string>([
    ['Calories', '277kcal'],
    ['Carbs', '0g'],
    ['Protein', '20g'],
    ['Fat', '22g'],
